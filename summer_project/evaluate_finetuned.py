...
ADAPTER_PATH = (
    "qwen2.5-3b-grader-qlora/final_adapter"
)

TEST_FILE = "dataset_split/test.json"

OUTPUT_DIR = Path("finetuned_results")
...
# Same sequence-generation behavior as baseline
DO_SAMPLE = False
...
print("=" * 70)
print("FINE-TUNED QLoRA EVALUATION")
print("=" * 70)
...
if torch.cuda.is_available():
    ...
    print("4-bit CUDA quantization will not be used.")
...
def parse_model_response(response, rubric):
    ...
    # --------------------------------------------------------
    # Validate against actual rubric maximum
    # --------------------------------------------------------
